                        ...
                        <form method="post" action="{{ route('courses.update', $course ) }}" enctype="multipart/form-data" autocomplete="off">
                            ...
                            <div class="pl-lg-4">
                                ...
                                <div class="form-group{{ $errors->has('link') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="link" id="input-link" class="form-control form-control-alternative{{ $errors->has('password') ? ' is-invalid' : '' }}" placeholder="{{ __('Link') }}" value="{{ $course->link }}" required>
